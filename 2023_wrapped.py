...
# Get the address
col2.markdown("Enter your Ethereum address here:")
address = str(col2.text_input('',help('ENS not supported, please enter 42-character hexadecimal address starting with "0x"')))
